...
import { message, Select, Modal, Button, Card, DatePicker } from 'antd';
        ...
        <div className="row mt-2 mb-2 ms-2 me-2">
          <div className="col-md-12">
            <div className="row mb-2">
              ...
              <div className="col-12 col-md-4 mt-2" style={{ marginLeft: "-100px" }}>
                3
                <button
                    ...
                    <tr key={item.EMPID}>
                      ...
                      <td>
                        ...
                        <button
                            ...
                            onClick={() => handleEditClick(item)} // Pass employee object to the edit handler
                          >
